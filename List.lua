...
function Spy:AddPlayerData(name, class, level, race, guild, isEnemy, isGuess, isPVP)
	local info = {}
	info.class = class
...
function Spy:UpdatePlayerData(name, class, level, race, guild, isEnemy, isGuess, isPVP)
	local detected = true
	local playerData = SpyPerCharDB.PlayerData[name]
	if not playerData then
		playerData = Spy:AddPlayerData(name, class, level, race, guild, isEnemy, isGuess, isPVP)
	else
